...
export const offlinePacks: OfflinePack[] = [
  { id: "internal-medicine", kind: "subject", title: "Internal Medicine", detail: "Clinical pathways, cardiovascular lessons, cases, reasoning, and mistakes.", urls: ["/learn", "/routes", "/coverage", "/learning-graph", "/cases", "/reasoning-ladder", "/misconceptions", "/learn/cardiovascular/cardiac-cycle", "/learn/cardiovascular/cardiac-output", "/mistakes", "/maps", "/note-workspace"] },
  ...
  { id: "cardiovascular", kind: "system", title: "Cardiovascular", detail: "Cardiac cycle, cardiac output, clinical reasoning, visual lab, and recall.", urls: ["/learn/cardiovascular/cardiac-cycle", "/learn/cardiovascular/cardiac-output", "/reasoning-ladder", "/visual-lab", "/review", "/maps", "/note-workspace"] },
