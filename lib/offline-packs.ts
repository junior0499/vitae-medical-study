...
export const offlinePacks: OfflinePack[] = [
  ...
  { id: "cardiovascular", kind: "system", title: "Cardiovascular", detail: "Cardiac cycle, output, clinical encounter, strict mastery proof, progress testing, and recall.", urls: ["/cardiovascular-pathway", "/learn/cardiovascular/cardiac-cycle", "/learn/cardiovascular/cardiac-output", "/clinical-encounter", "/mastery-proof", "/reasoning-ladder", "/visual-lab", "/review", "/maps", "/note-workspace"] },
  ...
  { id: "exam-sprint", kind: "exam", title: "Exam sprint", detail: "Assessment, spaced recall, strict proof, item quality, viva, blueprint, and timed practice.", urls: ["/today", "/practice", "/assessment", "/review", "/mistakes", "/question-studio", "/question-quality", "/mastery-proof", "/viva", "/interleaved", "/confidence", "/exam-blueprint"] },
