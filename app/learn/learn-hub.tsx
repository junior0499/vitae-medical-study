...
export function LearnHub() {
  ...
  return (
    <div className="learning-page">
      ...
      <section className="learning-tools" aria-labelledby="learning-tools-title"><header className="section-header"><div><span className="eyebrow">Connected learning loop</span><h2 id="learning-tools-title">Measure, learn, apply, correct</h2></div><a href="/learning-graph">Open unified graph →</a></header><div><a href="/diagnostic"><span>01</span><strong>Starting diagnostic</strong><p>Measure both live foundation domains.</p></a><a href="/learning-graph"><span>02</span><strong>Learning graph</strong><p>Trace objectives from source to mastery.</p></a><a href="/cases"><span>03</span><strong>Progressive cases</strong><p>Make one source-grounded decision at a time.</p></a><a href="/visual-lab"><span>04</span><strong>Visual laboratory</strong><p>Interpret pressure and flow patterns.</p></a><a href="/viva"><span>05</span><strong>Oral viva</strong><p>Explain mechanisms aloud or by typing.</p></a><a href="/comparisons"><span>06</span><strong>Normal vs disease</strong><p>Compare supported mechanisms beside source gates.</p></a><a href="/interleaved"><span>07</span><strong>Interleaved review</strong><p>Mix related topics and record confidence.</p></a><a href="/confidence"><span>08</span><strong>Confidence calibration</strong><p>Find certain errors and uncertain strengths.</p></a><a href="/exam-blueprint"><span>09</span><strong>Exam blueprint</strong><p>Connect objectives to assessment lanes.</p></a><a href="/routes"><span>10</span><strong>Subject routes</strong><p>Follow prerequisites before clinical disease.</p></a><a href="/assessment"><span>11</span><strong>Assessment Centre</strong><p>Use source-trailed MCQs, SAQs, and Mini-OSCEs.</p></a><a href="/mistakes"><span>12</span><strong>Mistake notebook</strong><p>Turn every wrong answer into a scheduled correction.</p></a><a href="/maps"><span>13</span><strong>Sideways maps</strong><p>Connect the clean notes you wrote yourself.</p></a><a href="/offline"><span>14</span><strong>Travel mode</strong><p>Carry lightweight lessons and queue private drafts.</p></a><a href="/source-search"><span>15</span><strong>Approved source search</strong><p>Jump from a topic to its reviewed chapter or page.</p></a><a href="/history"><span>16</span><strong>Learning history</strong><p>Recover an earlier note, map, mapping, or draft.</p></a><a href="/backup"><span>17</span><strong>Private backup</strong><p>Export the complete structured learning archive.</p></a></div></section>
