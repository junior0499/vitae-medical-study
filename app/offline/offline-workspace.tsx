...
const corePack = ["/learn", "/routes", "/learning-graph", "/diagnostic", "/cases", "/visual-lab", "/practice", "/viva", "/comparisons", "/interleaved", "/confidence", "/exam-blueprint", "/learn/cardiovascular/cardiac-cycle", "/learn/cardiovascular/cardiac-output", "/assessment", "/review", "/mistakes", "/maps", "/offline"];
