...
export function QuestionStudioWorkspace() {
  ...
  return <div className="question-studio-page">
    <header className="question-studio-hero"><div><span className="eyebrow"><i /> Recommendation 32 · Approved-source questions</span><h1>Turn one exact passage<br />into questions you can trust.</h1><p>Poh-tah-toh prepares MCQ, SAQ, viva, and clinical-case drafts only when the objective, uploaded section, deep index, and mapping are approved. Every draft waits for your review.</p></div><div className="question-studio-metrics"><span><strong>{summary.pending}</strong><small>awaiting review</small></span><span><strong>{summary.approved}</strong><small>approved</small></span><span><strong>{eligible.length}</strong><small>eligible objectives</small></span></div></header>
